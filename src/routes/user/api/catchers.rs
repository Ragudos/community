...
#[catch(401)]
pub fn unauthorized_user_api() -> ApiResponse {
    ApiResponse::Toast(
        Status::Unauthorized,
        Toast::error(Some("This action requires that you log in".to_string())),
    )
}

#[catch(403)]
pub fn forbidden_user_api() -> ApiResponse {
    ApiResponse::Toast(
        Status::Forbidden,
        Toast::error(Some(
...
#[catch(500)]
pub fn internal_server_error_user_api() -> ApiResponse {
    ApiResponse::Toast(
...
#[catch(404)]
pub fn not_found_user_api() -> ApiResponse {
    ApiResponse::Toast(
        Status::NotFound,
...
#[catch(default)]
pub fn default_user_api_error() -> ApiResponse {
    ApiResponse::Toast(
        Status::InternalServerError,
